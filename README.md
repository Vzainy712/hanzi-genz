...
- 💬 **Hội thoại nhập vai (chế độ immersion)**: **20 tình huống**, 2 kiểu chơi. **🌿 Hội thoại tự nhiên PHÂN NHÁNH — 12 kịch bản** (taxi, ăn lẩu, cắt tóc, KTV, khiếu nại hàng online, thuê nhà, phỏng vấn, ngân hàng, leo núi, game online, thể thao, nhảy bungee — 92 node/240 lựa chọn): không có đúng/sai — mọi lựa chọn đều đi tiếp và **NPC phản hồi khác nhau theo từng câu bạn chọn** (~20-24 câu thoại/ván), cuối buổi chấm "EQ giao tiếp". **🎯 Luyện cú pháp** (8 kịch bản): chọn câu đúng, sai nhận gợi ý tấu hài. **Vietsub che mờ** — chỉ chữ Hán + pinyin + audio tự phát; bấm dòng mờ khi cần.
